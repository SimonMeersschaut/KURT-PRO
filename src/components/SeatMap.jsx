...
export default function SeatMap({ zone, startDate, timeRange, onSeatClick, selectedSeatNr, reservationNr}) {
  ...
  const handleSeatClick = (seatNr) => {
    if (onSeatClick) {
      const seat = availabilities[seatNr];
      onSeatClick(seat);
    }
  };
